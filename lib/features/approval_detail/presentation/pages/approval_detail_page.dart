...
import '../bloc/approval_action_cubit.dart';
...
class ApprovalDetailPage extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return BlocListener<ApprovalActionCubit, ApprovalActionState>(
    ...
    return Container(
      ...
      child: Column(
        ...
        children: [
          ...
          const Divider(),
          const SizedBox(height: 10),
          _InfoRow(icon: Icons.person_outline, label: 'Requested by', value: item.requester),
      ...
      child: Row(
        children: [
          Container(
            ...
            child: const Icon(Icons.monetization_on_outlined, color: AppTheme.primaryColor),
          ),
...
class _PayloadCard extends StatelessWidget {
  ...
  Map<String, String> _buildPayload(ApprovalItem item) {
...
class _ActionBar extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return Container(
      ...
      child: SafeArea(
        child: BlocBuilder<ApprovalActionCubit, ApprovalActionState>(
          builder: (context, state) {
            final isLoading = state is ApprovalActionLoading;
            return Padding(
  ...
  void _showApproveDialog(BuildContext context) {
    final cubit = context.read<ApprovalActionCubit>();
    showDialog(
      context: context,
      builder: (dialogCtx) => AlertDialog(
        ...
        actions: [
          ...
          FilledButton(
            style: FilledButton.styleFrom(backgroundColor: AppTheme.approvedColor),
            onPressed: () {
      ...
      builder: (_) => StatefulBuilder(
        builder: (ctx, setState) => AlertDialog(
          ...
          actions: [
            ...
            FilledButton(
              style: FilledButton.styleFrom(backgroundColor: AppTheme.rejectedColor),
